...
<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>css/styleteam.css"/>
...
<body>
<div class="wrapper">
  <div class="singlefish"><img src="<?php echo base_url();?>/public/images/fishsingle.png" width="75" height="70" /></div>
  <div class="header">
    <div class="logo"><a href="index.html"><img src="<?php echo base_url();?>/public/images/logo.png" width="358" height="139" border="0" /></a></div>
    <div class="ico-box">
    ...
    <div class="navigation">
      <ul class="nav">
        ...
        <li><a href="#">Initiatives</a>
          <ul>
            <li><a href="currentinitiatives.html">Current Initiatives</a></li>
            <li><a href="pastInitiatives.html">Past Initiatives</a></li>
          </ul>
        </li>
        <li><a href="youcanhelp.html">You can help!</a>
   		<ul>
  ...
  <div class="con-main1">
          ...
          <ul class="slides">
            ...
            <li>
              <div class="descfounder"><strong><span style="color:#000">Prahlad Kakar</span></strong><br />
                ...
                <div class="closebutt1"><img src="<?php echo base_url();?>/public/images/closebutton.png" width="25" height="25" /></div>
              </div>
              <img src="<?php echo base_url();?>/public/images/founderPralhad.jpg" width="300" height="230" />
              </li>
              <li>
              <div class="descfounder"><strong><span style="color:#000">Mitali Dutt Kakar</span></strong><br />
                ...
                <div><img src="<?php echo base_url();?>/public/images/closebutton.png" width="25" height="25" class="closebutt"/></div>
              </div>
              <img src="<?php echo base_url();?>/public/images/founderMitali.jpg" width="300" height="230" /> </li>
          </ul>
        </div>
      </div>
    </div>
    <div class="con2">
      ...
      <div class="executivedirector"> <span class="descexecdirector"><strong><span style="color:#000">Nayantara Jain</span></strong><br />
        ...
        <img src="<?php echo base_url();?>/public/images/closebutton.png" width="25" height="25" /></span> <img src="<?php echo base_url();?>/public/images/executivedirector.jpg" width="300" height="230" /> </div>
    </div>
    <div class="con3">
  ...
  <div class="con-main2">
          ...
          <ul class="slides">
            <li>
              <div class="descbod"><strong><span style="color:#000">Sumer Verma</span></strong><br />
                ...
                <div><img src="<?php echo base_url();?>/public/images/closebutton.png" width="25" height="25" class="closebutt1"/></div>
              </div>
              <img src="<?php echo base_url();?>/public/images/boardofdirectors.jpg" width="300" height="230" /> </li>
        ...
        <div class="flexslider">
          <ul class="slides">
            <li>
              ...
              <img src="<?php echo base_url();?>/public/images/advisors.jpg" width="300" height="230" /> </li>
    ...
    <div class="con6">
      ...
      <div class="administrative"><img src="<?php echo base_url();?>/public/images/nopic.png" width="300" height="230" /></div>
    </div>
  </div>
</div>
